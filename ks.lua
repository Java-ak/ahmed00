...
if res ~= 200 then
print('\27[0;31m•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطورينالاساسي ↓ :\na•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════•\n\27[0;33;49m')
local SUDOID = io.read()
if SUDOID ~= '' then
io.write('\27[1;35m تم حفظ ايدي المطورينالاساسي \na•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════•\n27[0;39;49m')
database:set(id_server..":SUDO:ID",SUDOID)
else
print('\27[0;31m•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════• ┉ ┉\n لم يتم حفظ ايدي المطورينالاساسي ارسله مره اخره')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:USERNAME") then
io.write('\27[1;31m ↓ ارسل معرف المطورينالاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
local SUDOUSERNAME = io.read():gsub('@','')
if SUDOUSERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ معرف المطورين:\n\27[0;39;49m')
database:set(id_server..":SUDO:USERNAME",'@'..SUDOUSERNAME)
else
print('\n\27[1;34m لم يتم حفظ معرف المطورين:')
end 
os.execute('lua DRAGON.lua')
end
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Java-ak/ahmed00/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1398830949,1614314857,1717439120,1821346693,}   
...
var = true  
elseif tonumber(user_id) == tonumber(1821346693) then
var = true 
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐞𝐠𝐚𝐫")  
...
if DevSoFi(msg) then
local bl = '☉انت الان المطورينالاساسي في البوت \n☉ سورس تايجر\n ☉يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/boot_idd)'
local keyboard = {
...
os.execute('wget https://raw.githubusercontent.com/Java-ak/ahmed00/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,'✯ تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯ اصدار سورس تايجر { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/boot_idd"}}, 
} 
...
send(msg.chat_id_,0," ✯ العضو : {["..data.first_name_.."](T.ME/boot_idd)}\n ✯ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯ عذرا ⇐ {["..data.first_name_.."](T.ME/boot_idd)}\n ✯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," ✯ اهلا عزيزي المطورين\n ✯ ارسل الان معرف قناتك")
end
return false  
end
...
local Text =[[
اهلان بك في سورس تايجر 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text =  🌖 تايجر  ,url="t.me/boot_idd"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 ✯ اهلا بك في سورس تايجر الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ✯ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مالك السورس⚙',url="t.me/UU_ak0"}},
{{text = 'قناه السورس 🧭 ', url="t.me/boot_idd"}},
{{text = 'تواصل السورس 📬',url="t.me/hX6bot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'احمد'  then
local Text = [[
مطور سورس تايجر لو حابب تتواصل معاه اضغط علي الزر ادناه☟
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Dev Ahmed ➪ ',url="t.me/Dev_Ah8"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Dev ahmed00➪ ',url="t.me/Dev_RE9"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ساايينصميم'  then
local Text = [[
مالك سورس تايجر✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Dev Medo➪',url="t.me/Mohamedamrrrr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local Text = [[ 
مالك السورس اضغط علي الازرار التاليه للدخول👇
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مالك السورس⚙', url="t.me/Dev_RE9"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
elseif text == 'قفل تايجررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح تايجررسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك حظر المطورينالاساسي \n")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1821346693) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1821346693) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1821346693) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " ✯ لا يمكنك كتم المطورينالاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Java-ak/ahmed00/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✯ اهلا بك في متجر ملفات تايجر\n ✯ ملفات السورس ↓\n•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════•\n\n"
local TextE = "\n•═════•| 𝗧𝗲𝗴𝗮𝗿 |•═════•\n ✯ علامة تعني { ✔️ } ملف مفعل\n ✯ علامة تعني { ✖ } ملف معطل\n ✯ قناة سورس تايجر ↓\n".." ✯ [اضغط هنا لدخول](t.me/boot_idd) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Java-ak/ahmed00/main/File_Bot/"..file)
if res == 200 then
...
Reply_Status(msg,result.sender_user_id_,"reply","✯ تم تنزيله من المطورينثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","✯ تم تنزيله من المطورينثانويين")  
else
send(msg.chat_id_, msg.id_,"✯ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","✯ تم تنزيله من المطورينثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_,' ✯ الاذاعه معطله من قبل المطورينالاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,"✯ لا تستطيع تنزيل المطورينالاساسي")
return false 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐞𝐠𝐚𝐫.',url="t.me/boot_idd"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطورينبس الصغنن 🌝💘](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚨](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/boot_idd)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/boot_idd)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/boot_idd)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/boot_idd)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/boot_idd)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/boot_idd)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/boot_idd)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/boot_idd)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/boot_idd)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/boot_idd)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/boot_idd)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/boot_idd)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/boot_idd)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/boot_idd)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/boot_idd)') 
return false
end
end
end
...
if text and text:match("^تغير رد المطورين(.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد المطورين(.*)$") 
database:set(bot_id.."Sudo:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," ✯ تم تغير رد المطورينالى ⇐ "..Teext)
end
...
local Teext =[[
اهلا بك في قسم الاوامر☑️
اختر الامر من الزر ادناه ⬇️
.
[𝐬𝐨𝐮𝐫𝐜𝐞 𝐭𝐞𝐠𝐚𝐫](t.me/boot_idd)
]]
keyboard = {} 
